 ...
 */
@MyBatisRepository("FoundationSmsMapper")
public interface SmsMapper extends SmsMapperAuto {
     ...
     * @return 受影响的记录条数
     */
    long update(@Param("request") SmsPO request, @Param("passport") Passport passport);
