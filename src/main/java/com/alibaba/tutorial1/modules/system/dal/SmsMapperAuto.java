/**
 * @(#)SmsMapperAuto.java Copyright (c) 2014-2014  苏州犀牛网络科技有限公司 版权所有
 ...
 */
public interface SmsMapperAuto {
    /**
     * 插入记录.
     *
     * @param sms  实体对象
     * @return 实体对象的ID
     */
    long insert(@Param("sms") SmsPO sms, @Param("passport") Passport passport);
     ...
     * @return 受影响的记录条数
     */
    long insertBatch(@Param("list") List<SmsPO> list, @Param("passport") Passport passport);
     ...
     * @return 实体对象
     */
    SmsPO getById(@Param("id") Long id, @Param("passport") Passport passport);
     ...
     * @return 实体对象集合
     */
    List<SmsPO> getListByIds(@Param("list") List<Long> ids, @Param("passport") Passport passport);
