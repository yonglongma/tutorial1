 ...
 */
@MyBatisRepository("FoundationSmsUnsentMapper")
public interface SmsUnsentMapper extends SmsUnsentMapperAuto {
     ...
     * @return 受影响的记录条数
     */
    long update(@Param("request") SmsUnsentPO request, @Param("passport") Passport passport);
