/**
 * @(#)PassportMapperAuto.java Copyright (c) 2014-2014  苏州犀牛网络科技有限公司 版权所有
 ...
 */
public interface PassportMapperAuto {
    /**
     * 插入记录.
     *
     * @param passport 实体对象
     * @return 实体对象的ID
     */
    long insert(@Param("passport") PassportPO passport);
     ...
     * @return 受影响的记录条数
     */
    long insertBatch(@Param("list") List<PassportPO> list, @Param("passport") Passport passport);
     ...
     * @return 实体对象
     */
    PassportPO getById(@Param("id") Long id);
     ...
     * @return 实体对象集合
     */
    List<PassportPO> getListByIds(@Param("list") List<Long> ids, @Param("passport") Passport passport);
